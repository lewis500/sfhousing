            ...
            this.axes.forEach(function (axis) {
                ...
                if (!this.noFormats) {
                    handleTrans(axis.shapes.selectAll("text"))
                        .style("font-family", "Fenix")
                        .style("font-size", (chartHeight / 35 > 10 ? chartHeight / 35 : 12) + "px");
            ...
            theseShapes.append("text")
                ...
                .call(function () {
                    if (!self.chart.noFormats) {
                        this.style("font-family", "Fenix")
                            .style("font-size", (self.chart._heightPixels() / 35 > 10 ? self.chart._heightPixels() / 35 : 12) + "px")
                            .style("shape-rendering", "crispEdges");
                    }
                })
                .each(function () {
        ...
        this._drawText = function (duration) {
            if (this.storyLabel === null || this.storyLabel === undefined) {
                ...
                this.storyLabel = this.chart._group.append("text")
                    ...
                    .attr("y", this.chart._yPixels() + (this.chart._heightPixels() / 35 > 10 ? this.chart._heightPixels() / 35 : 12) * (xCount > 1 ? 1.25 : -1))
                    .call(function () {
                        if (!chart.noFormats) {
                            this.style("font-family", "Fenix")
                                .style("font-size", (chart._heightPixels() / 35 > 10 ? chart._heightPixels() / 35 : 12) + "px");
                        }
                    });
            }
            this.storyLabel
